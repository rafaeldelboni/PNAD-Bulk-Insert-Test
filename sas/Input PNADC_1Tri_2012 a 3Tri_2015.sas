...
@0063	V1029	   9.     /* Projeção da população do trim.    */
...
@0095	V3003	   $2.    /* Qual é o curso que frequenta      */
@0097	V3004	   $1.    /* Duração deste curso que requenta  */
@0098	V3005	   $1.    /* Curso que frequenta é seriado     */
@0099	V3006	   $2.    /* Qual é o ano/série que  frequenta */
@0101	V3007	   $1.    /* Concluiu outro curso de graduação */
@0102	V3008	   $1.    /* Anteriormente frequentou escola   */
@0103	V3009	   $2.    /* Curso mais elevado que frequentou */
@0105	V3010	   $1.    /* Duração do curso que frequentou   */
@0106	V3011	   $1.    /* Curso quefrequentou era seriado   */
@0107	V3012	   $1.    /* Aprovado na prim. série do curso  */
@0108	V3013	   $2.    /* Último ano/série que concluiu     */
@0110	V3014	   $1.    /* Concluiu o curso que frequentou   */
@0111	V4001	   $1.    /* Trabalhou 1 hr em ativ. remunerd. */
@0112	V4002	   $1.    /* Trabalhou 1 hr em produtos etc... */
@0113	V4003	   $1.    /* Fez algum bico pelo menos de 1 hr */
@0114	V4004	   $1.    /* Ajudou sem receber no domic. 1 hr */
@0115	V4005	   $1.    /* Afastado trabalho remunerado      */
@0116	V4006	   $1.    /* Motivo de estar afastado          */
@0117	V4007	   $1.    /* Durante afastameno recebia pagam. */
@0118	V4008	   $1.    /* Quanto tempo que estava afastado  */
@0119	V40081	   $2.    /* Tempo de afastamenento até 1 ano  */
@0121	V40082	   $2.    /* Tempo de afastamen. de 1 a 2 anos */
@0123	V40083	   $2.    /* Tempo de afastamen. mais d 2 anos */
...
@0137	V40132	   $1.    /* Seção da atividade                */
...
@0271	V4072	   $2.    /* Principal provid. p/conseg. trab. */
@0273	V4073	   $1.    /* Gostaria de ter trabalhado        */
@0274	V4074	   $1.    /* Motivo de não ter tomado provid.  */
@0275	V4077	   $1.    /* Poderia ter começado a trabalhar  */
@0276	V4078	   $1.    /* Motivo p/ñ querer/começar a trab. */
...
@0324	VD4023	   $1.    /* Pq ñ proc./ñ gost./ñ disp.p/trab. */;
run;
